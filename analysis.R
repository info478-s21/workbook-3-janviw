...
ggplot(data_wider) +
  ...
  xlim(-15, 20) +
  ylim(-15, 20)
ggsave("charts/difference_graph.png")

# this graph shows us a trend that HALEs and life expectancy both have increased 
# in most countries from 1990 to 2016. The positive correlation suggest as life expectancy 
# increases so does HALE which supports the idea that as people live longer they live 
# healthier lives.
